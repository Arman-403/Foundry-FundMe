...
contract FundMe {
    ...
    function fund() public payable {
        require(getConversion(msg.value) >= MIN_USD, "Send More Eth");
    ...
    function withdraw() external OwnerOnly {
        ...
        // gas efficient version - copying s_funders array in memory its cheaper to hanlde ( remeber here we got MLOAD MSTORE that need ~3 gas)
